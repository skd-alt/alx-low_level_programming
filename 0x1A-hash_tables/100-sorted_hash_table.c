...
/**
 * add_sh_node - adds a node at the beginning of a shash at a given index
...
shash_node_t *add_sh_node(shash_node_t **h, const char *key, const char *value)
{
	shash_node_t *tmp;
...
/**
 * add_node_dll - adds a node on the DLL of the shash table
 * @ht: pointer to the table
 * @new: new node to add
 */

void add_node_dll(shash_table_t *ht, shash_node_t *new)
{
...
int shash_table_set(shash_table_t *ht, const char *key, const char *value)
{
	...
	new = add_sh_node(&(ht->array[k_index]), key, value);
